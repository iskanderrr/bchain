...
<body>
                ...
                <fieldset>
                    ...
                    <div class="password">
                        <input style="border:none;input:focus {outline:none;};width: 440px;padding-left: 18px;"
                            type='password' placeholder="Your password here" name="pwd">
  ...
  " class="button-gradient">
                ...
                if (isset($_POST['login'])) {
                    ...
                    try {
                        ...
                        if ($data = $res->fetchAll(PDO::FETCH_ASSOC)) {
                            if ($data[0]["role"]=== "UNVERIFIED"){
                                echo "<p ><center style='color:#A83522;font-weight:600;'>Verify your email before logging in</center></p>";
                                }
                            else{
                                $_SESSION["connecte"] = "1";
                            $_SESSION["user"] = $data[0]["userId"];
                            $_SESSION["nom"] = $data[0]["fullName"];
        ...
        <p class="text-secondary-200" style="margin-top: 32px;">Don’t have an account? <a href="register.php"
                style="font-size: 16px;">Sign up</a></p>
    </div>
    <div class="right">
        <img src="/css/frame-100.png" alt="Right Frame">
    </div>
</body>
