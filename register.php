                ...
                if (isset($_POST['email'])) {
                    ...
                    try {
                        ...
                        if ($data = $res->fetchAll(PDO::FETCH_ASSOC)) {
                            ...
                            $req = "INSERT INTO users (email, password, fullName, phoneNumber, role) VALUES (:email, :pwd, :name, :phone, 'UNVERIFIED')";
                            ...
                            $verificationCode=generateVerification($newUserId);
                            



                            mailTo($email,$name,"Welcome to B-chain ! \n click on this link to verify your account https://b-chain.space/verify.php?token=".$verificationCode);
